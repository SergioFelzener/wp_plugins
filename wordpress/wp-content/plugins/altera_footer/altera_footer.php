...
function add_whatsapp(){
    ...
    echo "<link rel='stylesheet' href='https://maxcdn.bootstrapcdn.com/font-awesome/4.5.0/css/font-awesome.min.css'>
                <a href='https://wa.me/55(aqui seu numero com ddd | tudo junto)?text=Adorei%20seu%20artigo' style='position:fixed;width:48px;height:40px;bottom:30px;right:40px;background-color:#25d366;color:#FFF;border-radius:60px;text-align:center;font-size:26px;box-shadow: 1px 1px 2px #888;
